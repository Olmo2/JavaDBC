...
public class StartView {
	...
	/**
	 * Lista los cines disponibles PRIVADO
	 */
	...
	private void borrarCine() throws NumberFormatException, IOException {
		...
		// solicito un ID
		System.out.println("Seleccione el Id del cine que desea borrar");
		int numero = Integer.parseInt(br.readLine());

		// recojo el cine se lo paso a la parte de la view que lo crea
		CineBean unCine = cines.getCine(numero);
			ModificarCineView.borrarCine(unCine);
